...
// need to initalize each element for ultrasonic and light intensity sensor
...
void loop(){
  ...
  // CCW rotation 360 degree
  Serial.println("360 degree counter-clockwise");
  display.clearDisplay();display.setCursor(0, 0);
  display.println("CCW 360 degree");
  display.display();
  rotate_1();
  delay(rotate_90_time * 4);
  Serial.println("=================================done=================================");
